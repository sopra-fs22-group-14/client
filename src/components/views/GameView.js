...
const GameView = () => {
  ...
  /*
   ...
   whenever a new round starts (so when roundNr changes!)
  */
  useEffect(async () => {
    try {
  ...
  */
  useInterval(async () => {
    ...
    // if a winner was decided, display the winner!
    fetchWinner();
  ...
  const fetchRoundData = async () => {
    try {
      ...
      // TODO setBlackCard and setChoices (played Cards) OR just setRound
